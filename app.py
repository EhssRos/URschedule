...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://urschedulerdb_l97d_user:gfVQGe6MQQMpkXIUP16zWt7Zczy06k48@dpg-cvps8hruibrs7383ua50-a/urschedulerdb_l97d'#'sqlite:///schedule.db'##'sqlite:///schedule.db'#'postgresql://scheduler_gp4w_user:4I2dxWzkZ6luTNRPB2MQxYCUPYoneIsq@dpg-cs8e34tsvqrc73bpaq2g-a/scheduler_gp4w'  # Database URI 'sqlite:///schedule.db'#
